...
namespace BusinessLayer.ValidationRules
{
    public class ContactValidator : AbstractValidator<Contact>
    {
        public ContactValidator()
        {
            ...
            RuleFor(x => x.Subject).MaximumLength(20).WithMessage("Lütfen en az 3 karakter girişi yapın");
            RuleFor(x => x.UserName).MaximumLength(20).WithMessage("Lütfen en az 3 karakter girişi yapın");
